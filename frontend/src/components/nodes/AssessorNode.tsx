...
export function AssessorNode({ data }: { data: AssessorNodeData }) {
  ...
  const endColor =
    ...
    data.endState === "fragmented" ? "#f59e0b" : "#ef4444";
  return (
    <div className="px-5 py-3 rounded-full border-2 border-zinc-500 bg-zinc-800 min-w-[200px] font-mono">
      ...
      <div className="flex items-center justify-between text-[9px]">
        <span style={{ color: endColor }} className="font-bold uppercase">{data.endState || "pending"}</span>
